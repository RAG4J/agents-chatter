...
public class FootballAgent extends SubscriberAgent {
    ...
    public FootballAgent(ChatClient chatClient, ChatMemory chatMemory, MessageService messageService, AgentPublisher agentPublisher, PresenceService presenceService) {
